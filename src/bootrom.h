...
#define BOOTROM_PART_ATTR_DEST_CPU_NONE  0
#define BOOTROM_PART_ATTR_DEST_CPU_A53_0 1
#define BOOTROM_PART_ATTR_DEST_CPU_A53_1 2
#define BOOTROM_PART_ATTR_DEST_CPU_A53_2 3
#define BOOTROM_PART_ATTR_DEST_CPU_A53_3 4
#define BOOTROM_PART_ATTR_DEST_CPU_R5_0  5
#define BOOTROM_PART_ATTR_DEST_CPU_R5_1  6
#define BOOTROM_PART_ATTR_DEST_CPU_R5_L  7

#define BOOTROM_PART_ATTR_ENCRYPTION_OFF 7
#define BOOTROM_PART_ATTR_ENCRYPTION_YES 1
#define BOOTROM_PART_ATTR_ENCRYPTION_NO  0
...
#define BOOTROM_PART_ATTR_A5X_EXEC_S_64  0
#define BOOTROM_PART_ATTR_A5X_EXEC_S_32  1

#define BOOTROM_PART_ATTR_EXC_LVL_OFF    1
#define BOOTROM_PART_ATTR_EXC_LVL_EL0    0
#define BOOTROM_PART_ATTR_EXC_LVL_EL1    1
#define BOOTROM_PART_ATTR_EXC_LVL_EL2    2
#define BOOTROM_PART_ATTR_EXC_LVL_EL3    3

#define BOOTROM_PART_ATTR_TRUST_ZONE_OFF 0
#define BOOTROM_PART_ATTR_TRUST_ZONE_ON  1
#define BOOTROM_PART_ATTR_TRUST_ZONE_OFF 0
